...
def parse_args(argv=None):
    ...
    parser.set_defaults(no_bar=False, display=True, resume=False, output_coco_json=False, output_web_json=False, shuffle=False,
...
def evalimage(net:Yolact, path:str, save_path:str=None):
    ...
    if save_path is None:
        ...
        #plt.title(path)       
        cv2.imwrite(os.getcwd() + os.sep + "results_img" + os.sep + path.split("/")[-1], cv2.cvtColor(img_numpy, cv2.COLOR_RGB2BGR))
...
if __name__ == '__main__':
    ...
    if args.config is None:
        ...
        args.config = model_path.model_name
